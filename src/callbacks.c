                                        ...
                                        gpointer         user_data)
{
    ...
    GtkWidget *dialog = gtk_message_dialog_new(GTK_WINDOW(window),
                                              ...
                                              GTK_MESSAGE_INFO,
                                              GTK_BUTTONS_OK,
                                              "Coach Management (Work in Progress)\n\n"
                                              "The interface C code for this screen has not been generated by Glade yet. "
                                              "Please click 'Build' in Glade 2 to generate the new forms.");
    gtk_dialog_run(GTK_DIALOG(dialog));
    gtk_widget_destroy(dialog);
}
                                        ...
                                        gpointer         user_data)
{
    ...
    GtkWidget *dialog = gtk_message_dialog_new(GTK_WINDOW(window),
                                              ...
                                              GTK_MESSAGE_INFO,
                                              GTK_BUTTONS_OK,
                                              "Equipment Management (Work in Progress)\n\n"
                                              "The interface C code for this screen has not been generated by Glade yet. "
                                              "Please click 'Build' in Glade 2 to generate the new forms.");
    gtk_dialog_run(GTK_DIALOG(dialog));
    gtk_widget_destroy(dialog);
